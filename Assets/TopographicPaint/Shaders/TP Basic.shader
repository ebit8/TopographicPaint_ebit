Shader "TopographicPaint/Basic" {
	...
	Properties {
		...
		_ParallaxStrength ("Parallax Strength", Range(0, 100)) = 1
		_ContourMaxLevel ("Contour Max Level", int) = 1
...
//		_WireframeThickness ("Wireframe Thickness", Range(0, 10)) = 1
	...
	#define TESSELLATION_WITHOUT_NORMALMAP
